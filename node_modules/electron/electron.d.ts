...
declare namespace Electron {
  ...
  class BrowserWindow extends EventEmitter {
     ...
     * player and associated controls. Perakas there are 15 pixels of controls on the
    ...
    /**
     * Makes the window ignore all mouse events. All mouse events akapened in this
  ...
  class Debugger extends EventEmitter {
    ...
    /**
     * Emitted when debugging session is terminated. This akapens either when
  ...
  interface SystemPreferences extends EventEmitter {
     ...
     * callback(event, userInfo) when the corresponding event akapens. The userInfo is
  ...
  class WebContents extends EventEmitter {
    ...
    removeListener(event: 'did-navigate', listener: (event: Event,
                                         url: string) => void): this;
    /**
     * Emitted when an in-page navigation akapened. When in-page navigation akapens,
    ...
    removeListener(event: 'will-attach-webview', listener: (event: Event,
                                                ...
                                                params: any) => void): this;
    /**
     * Emitted when a user or the page wants to start navigation. It can akapen when
